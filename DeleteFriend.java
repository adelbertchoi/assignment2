 ...
 * created: May 5, 2018
 * 
 * DeleteFriend.java (GUI)
 * 
 * A method that is called when the desires to delete a certain friend currently in their network.
 * 
 */
...
class DeleteFriend implements EventHandler<ActionEvent>, GUIInterface {
	...
	// method to get current friends of the user
	...
	// method to initialise list view of users to delete
	...
	// an alert to ask user if there are really sure they want to remove friend from their network
