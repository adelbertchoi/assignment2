 ...
 * = SearchUser.java (GUI)
 * 
 * This class is called from the main menu. 
 * If the user desires to search a user. 
 * If a user is found the show user profile is then instantiated. 
 * 
 */
...
public class SearchUser implements EventHandler<ActionEvent>, GUIInterface {
	...
	// a method to check if entered user name actually exists or not
	...
	public void handle(ActionEvent e) { 		
		...
		// when search user button is clicked
