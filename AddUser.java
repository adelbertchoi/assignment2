 ...
 * = AddUser.java (GUI)
 * 
 * This object is instantiated from the main menu when a new user is 
 * desired to be added. Appropriate exception handling are also 
 * implemented to ensure that correct username startup details are properly 
 * added to construct a new user.  
 * 
 */
...
class AddUser implements EventHandler<ActionEvent>, GUIInterface {
	...
	// method to initialise add user scene
	...
	// method to validate user input when creating a user
