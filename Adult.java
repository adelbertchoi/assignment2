 ...
 * Adult.java 
 * 
 * This is a class that is used to create adult users
 * An adult can have a partner and dependents
 * 
 */
...
public class Adult extends User {
	...
	@Override
	// adult delete friend, a different implementation when there is adult has dependents
	public void deleteFriend(User friend) throws NoParentException {
		...
		// if above condition we can delete from adult friend list
