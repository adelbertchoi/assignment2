 ...
 * = Connections.java
 * 
 * This is a Connections class. It handles all relationship type objects
 * This class contains an arraylist storing all relationship objects
 * This class will handle adding, deleting, finding relationships created by the users. 
 * It is like a database for the all user relationships.
 * 
 * 
 */
...
public class Connections {
	...
	public void deleteAllUserRelationships(String username) {
		for (int i = 0; i < relationships.size(); i++) {
			...
			if (relationships.get(i).getUsernameTwo().equals(username)) {
				relationships.remove(i);
			}
		}
	}
	
	// method to change the relationship of users
