...
* created: May 5, 2018
* 
* ListAllUsers.java (GUI)
* 
* This class is instantiated from the main menu. It lists all users currently in the social network
* A user can be selected and their corresponding profiles can be viewed. 
* 
*/
...
class ListAllUsers implements EventHandler<ActionEvent>, GUIInterface {
	...
	// method to filter selection showed on the interface
	// for example, if user selects Adult type users, choices will only include adult type users
	...
	// method to intiialise the users list view
	...
	public void handle(ActionEvent e) { 		
		...
		// handler of user friendly message
		...
		// button handler when user wants to select a specific subset of users
