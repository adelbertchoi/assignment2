...
* FindFriend.java (GUI)
* 
* An additional method that is used when a user would like to find 
* friend of a friend within the current social network.
* 
*/
...
class FindFriend implements EventHandler<ActionEvent>, GUIInterface {
	...
	// find friend constructor
	public FindFriend(Stage primaryStage) {
		this.primaryStage = primaryStage;
	}
	
	// get a list of users that are not friends of current user
	...
	// create a list of friends that are not in current users network
	// these are the users that the current user is allowed to search a path to
	...
	// intialise vertex to implement shortest path algortihm
	...
	// method to add edges to the current graph
	...
	// method to find the path to a friend
	// using dijkstra.getPath method
