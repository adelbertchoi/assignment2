 ...
 * = MyUI.java (GUI)
 * 
 * This class contains a lot of helper static methods that are used 
 * throughout the assignment when creating GUI scenes. These include 
 * buttons, header, texts, fields, etc. 
 * 
 */
...
public class myUI {
	...
	// creating Vboxes for relationships
