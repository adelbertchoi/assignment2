 ...
 * = Profiles.java
 * 
 * This is a profiles class. It handles all users type objects
 * This class contains a hashmap storing all user objects
 * This class will handle adding, deleting, finding users etc. 
 * It is like a database for the users.
 * 
 * */
