...
* User.java 
* 
* Main user class. This is an abstract that has all instance variables
* of a user in the social network. The classes Adult, Child, and YoungChild
* all extend this class. The use of inheritance allows the subclasses to 
* get retrieve the instance variables of this abstract class. 
* 
*/
